...
public class export_succes extends javax.swing.JFrame {

    public export_succes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Table has been successfully Exported!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(export_succes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
